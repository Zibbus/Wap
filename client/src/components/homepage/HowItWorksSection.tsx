...
const steps = [
  ...
  {
    icon: <Dumbbell className="w-10 h-10 text-indigo-600" />,
    ...
    <section className="py-20 px-6 bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 max-w-6xl mx-auto text-center">
        {steps.map((step, i) => (
          <div
            key={i}
            className="flex flex-col items-center bg-indigo-50 rounded-2xl shadow-sm hover:shadow-md p-8 transition-transform hover:scale-105"
          >
